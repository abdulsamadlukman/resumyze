    ...
    <main className="!pt-0">
      ...
      <div className="flex flex-row w-full max-lg:flex-col-reverse">
        <section className="feedback-section bg-[url('/public/images/bg-small.svg')] bg-cover h-[100vh] sticky top-0 items-center justify-center">
          {imageUrl && resumeUrl && (
          <div className="animate-in fade-in duration-1000 gradient-border max-sm:m-0 h-[90%] max2xl:h-fit w-fit">
        ...
        <section className="feedback-section">
          ...
          {feedback ? (
            ...
            <img src="/public/images/resume-scan-2.gif" alt="scan-2"  className='w-full'/>
          )}
        </section>
      </div>
    </main>
